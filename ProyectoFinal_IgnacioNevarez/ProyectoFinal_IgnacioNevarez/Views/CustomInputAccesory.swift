...
class CustomInputAccessoryView: UIView {
    ...
    let sendButton = UIButton(title: "ENVIAR", titleColor: .black, font: .boldSystemFont(ofSize: 14), target: nil, action: nil)
    
    let placeholderLabel = UILabel(text: "Escribe el mensaje", font: .systemFont(ofSize: 16), textColor: .lightGray)
