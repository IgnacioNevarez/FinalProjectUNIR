...
class UserSearchCell: LBTAListCell<User> {
    ...
    let nameLabel = UILabel(text: "Nombre Completo", font: .boldSystemFont(ofSize: 16), textColor: .black)
    lazy var followButton = UIButton(title: "Seguir", titleColor: .black, font: .boldSystemFont(ofSize: 14), backgroundColor: .white, target: self, action: #selector(handleFollow))
    ...
    override var item: User! {
        didSet {
            ...
            if item.isFollowing == true {
                ...
                followButton.setTitle("No seguir", for: .normal)
            } else {
