...
class CreatePostController: UIViewController, UITextViewDelegate {
    ...
    lazy var postButton = UIButton(title: "Enviar", titleColor: .white, font: .boldSystemFont(ofSize: 14), backgroundColor: #colorLiteral(red: 0.1127949134, green: 0.5649430156, blue: 0.9994879365, alpha: 1), target: self, action: #selector(handlePost))
    
    let placeholderLabel = UILabel(text: "Escribe tú post...", font: .systemFont(ofSize: 14), textColor: .lightGray)
